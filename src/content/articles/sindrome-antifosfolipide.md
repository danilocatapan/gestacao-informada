...
lastUpdatedAt: 2026-06-08T18:05:48.794Z
medicalDisclaimer: Este conteúdo é educativo e não confirma síndrome antifosfolípide nem indica tratamento. Diagnóstico e cuidado exigem avaliação profissional e interpretação do histórico e dos exames.
aiAssistance:
  activities:
    - topic-research
    - source-triage
...
inspirationCredits:
  - name: Dr. Rodrigo Berger — placentação, trombofilia, SAAF e RCIU
    ...
    purpose: Usado somente para identificar dúvidas frequentes sobre SAAF e gestação.
safetyReview: []
sources:
  - title: EULAR recommendations for the management of antiphospholipid syndrome in adults
    ...
    publisher: European Alliance of Associations for Rheumatology
    accessedAt: 2026-06-08
    type: guideline
  - title: Managing antiphospholipid syndrome
    url: https://www.eular.org/document/download/216/e47c6f27-399e-40d5-80d2-b4be8b733861/302
    publisher: European Alliance of Associations for Rheumatology
    accessedAt: 2026-06-08
    type: institutional
...
Um material público do Dr. Rodrigo Berger ajudou a identificar a necessidade de explicar a sigla SAAF e sua relação com dúvidas gestacionais. Ele não foi usado como evidência clínica, revisão profissional ou endosso. As afirmações deste texto dependem das diretrizes listadas.

## Matriz de afirmações para revisão

| Afirmação editorial | Fonte principal | Pendência humana |
|---|---|---|
| Um exame positivo isolado não confirma SAF. | EULAR | Revisar linguagem dos critérios diagnósticos. |
| A condição pode se associar a trombose e complicações gestacionais definidas. | EULAR e ACOG | Revisão por especialista. |
| Perfil laboratorial e histórico influenciam a avaliação de risco. | EULAR | Confirmar clareza sem induzir autodiagnóstico. |

## Situação editorial

Este artigo está em `draft`. Precisa de revisão clínica profissional, especialmente dos critérios, limites dos exames e comunicação de risco.

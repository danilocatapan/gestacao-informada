...
| Parte dos casos permanece sem causa identificada. | ACOG | Revisar comunicação de prognóstico. |

## Situação editorial

Este artigo está em `draft`. Precisa de revisão clínica e psicológica profissionais, especialmente sobre escopo de investigação, diferenças entre diretrizes e comunicação de incertezas.
